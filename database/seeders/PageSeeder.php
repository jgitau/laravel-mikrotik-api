    ...
    public function run()
    {
        $pages = [
            ...
            [
                ...
                'page' => 'list_admins',
                'title' => 'List Admins',
                'url' => 'administrators/pg/list_admins',
                'module_id' => 10,
                'allowed_groups' => '1',
                'show_menu' => 1,
                'show_to' => NULL
            ...
            [
                ...
                'page' => 'list_groups',
                'title' => 'List Groups',
                'url' => 'administrators/pg/list_groups',
                'module_id' => 10,
                'allowed_groups' => '1',
                'show_menu' => 1,
                'show_to' => NULL
            ...
            [
                ...
                'url' => 'reports/pg/list_online_users',
                'module_id' => 7,
                'allowed_groups' => '1,2',
                'show_menu' => 1,
                'show_to' => NULL
            ...
            [
                ...
                'page' => 'config_client',
                'title' => 'Config Client',
                'url' => 'configs/pg/edit_config/clients',
                'module_id' => 19,
                'allowed_groups' => 0,
                'show_menu' => 0,
                'show_to' => 19
            ...
            [
                ...
                'page' => 'config_ads',
                'title' => 'Config Ads',
                'url' => 'configs/pg/edit_config/ads',
                'module_id' => 19,
                'allowed_groups' => 0,
                'show_menu' => 0,
                'show_to' => 19
            ...
            [
                ...
                'title' => 'Config Hotel Romms',
                'url' => 'configs/pg/edit_config/hotel_rooms',
                'module_id' => 19,
                'allowed_groups' => 0,
                'show_menu' => 0,
                'show_to' => 19
            ...
            [
                'id' => 82,
                'page' => 'config_social_plugins',
                'title' => 'Config Social Plugins',
                'url' => 'configs/pg/edit_config/social_plugins',
                'module_id' => 19,
                'allowed_groups' => 0,
                'show_menu' => 0,
                'show_to' => 19
            ...
            [
                ...
                'url' => 'configs/pg/edit_config/premium',
                'module_id' => 19,
                'allowed_groups' => 0,
                'show_menu' => 0,
                'show_to' => 19
